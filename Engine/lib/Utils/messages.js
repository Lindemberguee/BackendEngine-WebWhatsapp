    ...
    if ('sections' in message && !!message.sections) {
        ...
        if ('text' in message) {
            ...
            if ('caption' in message) {
                ...
                // Media header: the prepared media (m = { imageMessage } /
                // videoMessage / documentMessage) belongs INSIDE the header,
                // alongside hasMediaAttachment: true — not merged at top level.
                interactiveMessage.header = {
                    title: message.title,
                    subtitle: message.subtitle,
